...
# Bảng chuyển âm �# Bảng chuyển vần (rhyme) chữ → chuỗi phoneme (IPA Standard)
VN_RHYME_MAP = {
    # ── Nguyên âm đơn ──────────────────────────────────────────
    "a":   ["a:"],     "ă":   ["a"],       "â":   ["ɤ"],
    "e":   ["ɛ:"],     "ê":   ["e:"],      "i":   ["i:"],
    "o":   ["ɔ:"],     "ô":   ["o:"],      "ơ":   ["ɤ:"],
    "u":   ["u:"],     "ư":   ["ɯ:"],      "y":   ["i:"],
    # ── Nguyên âm đôi (2tokens) ────────────────────────────────
    "ia":  ["i","ə"],  "iê":  ["i","ə"],   "ie":  ["i","ə"],
    "ua":  ["u","ə"],  "uô":  ["u","ə"],   "uo":  ["u","ə"],
    "ưa":  ["ɯ","ə"],  "ươ":  ["ɯ","ə"],   "uơ":  ["ɯ","ə"],
    "oa":  ["w","a:"], "oă":  ["w","a"],   "oe":  ["w","ɛ:"],
    "oo":  ["ɔ:"],     
    "uy":  ["w","i:"], "ui":  ["u:","i"],  "oi":  ["ɔ:","i"],
    "ôi":  ["o:","i"], "ơi":  ["ɤ:","i"],  "ai":  ["a:","i"],
    "ay":  ["a","i"],  "ây":  ["ɤ","i"],   "au":  ["a","o"],
    "âu":  ["ɤ","o"],  "ao":  ["a:","o"],  "eo":  ["ɛ:","o"],
    "êu":  ["e:","o"], "iu":  ["i:","o"],  "ưu":  ["ɯ:","o"],
    # ── Vần khép (có âm cuối) ──────────────────────────────────
    ...
    "ung": ["u:","ŋ"],  "ưng": ["ɯ:","ŋ"],
    "anh": ["ɛ","ɲ"],   "ênh": ["e","ɲ"],   "inh": ["i","ɲ"],
    "ach": ["ɛ","c"],   "êch": ["e","c"],   "ich": ["i","c"],
    ...
    "uân": ["w","ɤ","n"],  "uyên":["w","i","ə","n"],
    "uynh":["w","i","ɲ"],  "oang":["w","a:","ŋ"], "uang":["w","a:","ŋ"],
    "uất": ["w","ɤ","t"],  "oat": ["w","a:","t"], "oac": ["w","a:","k"],
    "uat": ["w","a:","t"], "uyn": ["w","i:","n"],
    "ươn": ["ɯ","ə","n"],  "ướng":["ɯ","ə","ŋ"],  "ường":["ɯ","ə","ŋ"],
    "ươt": ["ɯ","ə","t"],  "ướp": ["ɯ","ə","p"],  "ươi": ["ɯ","ə","i"],
    "uôn": ["u","ə","n"],  "uông":["u","ə","ŋ"],  "uôt": ["u","ə","t"],
    "iên": ["i","ə","n"],  "iêng":["i","ə","ŋ"],  "iêt": ["i","ə","t"],
    "iêm": ["i","ə","m"],  "iêp": ["i","ə","p"],  "iêc": ["i","ə","k"],
}
